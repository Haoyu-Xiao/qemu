...
#ifndef NO_EMU_HOOKS // HouseEmu Patch for Compatabilities

#define TARGET_SIOCETHTOOL     0x8946		/* Ethtool interface		*/

#define TARGET_SIOCGMIIPHY     0x8947		/* Get address of MII PHY in use. */
#define TARGET_SIOCGMIIREG     0x8948		/* Read MII PHY register.	*/
#define TARGET_SIOCSMIIREG     0x8949		/* Write MII PHY register.	*/

#define TARGET_SIOCWANDEV      0x894A		/* get/set netdev parameters	*/

#define TARGET_SIOCOUTQNSD     0x894B		/* output queue size (not sent only) */
#define TARGET_SIOCGSKNS       0x894C		/* get socket network namespace */

#define TARGET_SIOCGIFVLAN	   0x8982	       /* 802.1Q VLAN support		*/
#define TARGET_SIOCSIFVLAN	   0x8983	       /* Set 802.1Q VLAN options 	*/

/* bonding calls */
#define TARGET_SIOCBONDENSLAVE        0x8990		/* enslave a device to the bond */
#define TARGET_SIOCBONDRELEASE        0x8991		/* release a slave from the bond*/
#define TARGET_SIOCBONDSETHWADDR      0x8992	/* set the hw addr of the bond  */
#define TARGET_SIOCBONDSLAVEINFOQUERY 0x8993   /* rtn info about slave state   */
#define TARGET_SIOCBONDINFOQUERY      0x8994	/* rtn info about bond state    */
#define TARGET_SIOCBONDCHANGEACTIVE   0x8995   /* update to a new active slave */

/* hardware time stamping: parameters in linux/net_tstamp.h */
#define TARGET_SIOCSHWTSTAMP	0x89b0		/* set and get config		*/
#define TARGET_SIOCGHWTSTAMP	0x89b1		/* get config			*/

/*
 *	These 16 ioctl calls are protocol private
 */
#define TARGET_SIOCPROTOPRIVATE_0  0x89E0	/* to 89EF */
#define TARGET_SIOCPROTOPRIVATE_1  0x89E1
#define TARGET_SIOCPROTOPRIVATE_2  0x89E2
#define TARGET_SIOCPROTOPRIVATE_3  0x89E3
#define TARGET_SIOCPROTOPRIVATE_4  0x89E4
#define TARGET_SIOCPROTOPRIVATE_5  0x89E5
#define TARGET_SIOCPROTOPRIVATE_6  0x89E6
#define TARGET_SIOCPROTOPRIVATE_7  0x89E7
#define TARGET_SIOCPROTOPRIVATE_8  0x89E8
#define TARGET_SIOCPROTOPRIVATE_9  0x89E9
#define TARGET_SIOCPROTOPRIVATE_A  0x89EA
#define TARGET_SIOCPROTOPRIVATE_B  0x89EB
#define TARGET_SIOCPROTOPRIVATE_C  0x89EC
#define TARGET_SIOCPROTOPRIVATE_D  0x89ED
#define TARGET_SIOCPROTOPRIVATE_E  0x89EE
#define TARGET_SIOCPROTOPRIVATE_F  0x89EF

#define SIOCPROTOPRIVATE_0 TARGET_SIOCPROTOPRIVATE_0
#define SIOCPROTOPRIVATE_1 TARGET_SIOCPROTOPRIVATE_1
#define SIOCPROTOPRIVATE_2 TARGET_SIOCPROTOPRIVATE_2
#define SIOCPROTOPRIVATE_3 TARGET_SIOCPROTOPRIVATE_3
#define SIOCPROTOPRIVATE_4 TARGET_SIOCPROTOPRIVATE_4
#define SIOCPROTOPRIVATE_5 TARGET_SIOCPROTOPRIVATE_5
#define SIOCPROTOPRIVATE_6 TARGET_SIOCPROTOPRIVATE_6
#define SIOCPROTOPRIVATE_7 TARGET_SIOCPROTOPRIVATE_7
#define SIOCPROTOPRIVATE_8 TARGET_SIOCPROTOPRIVATE_8
#define SIOCPROTOPRIVATE_9 TARGET_SIOCPROTOPRIVATE_9
#define SIOCPROTOPRIVATE_A TARGET_SIOCPROTOPRIVATE_A
#define SIOCPROTOPRIVATE_B TARGET_SIOCPROTOPRIVATE_B
#define SIOCPROTOPRIVATE_C TARGET_SIOCPROTOPRIVATE_C
#define SIOCPROTOPRIVATE_D TARGET_SIOCPROTOPRIVATE_D
#define SIOCPROTOPRIVATE_E TARGET_SIOCPROTOPRIVATE_E
#define SIOCPROTOPRIVATE_F TARGET_SIOCPROTOPRIVATE_F
 ...
 */ 
#define TARGET_SIOCDEVPRIVATE_0  0x89F0	/* to 89FF */
#define TARGET_SIOCDEVPRIVATE_1  0x89F1
#define TARGET_SIOCDEVPRIVATE_2  0x89F2
#define TARGET_SIOCDEVPRIVATE_3  0x89F3
#define TARGET_SIOCDEVPRIVATE_4  0x89F4
#define TARGET_SIOCDEVPRIVATE_5  0x89F5
#define TARGET_SIOCDEVPRIVATE_6  0x89F6
#define TARGET_SIOCDEVPRIVATE_7  0x89F7
#define TARGET_SIOCDEVPRIVATE_8  0x89F8
#define TARGET_SIOCDEVPRIVATE_9  0x89F9
#define TARGET_SIOCDEVPRIVATE_A  0x89FA
#define TARGET_SIOCDEVPRIVATE_B  0x89FB
#define TARGET_SIOCDEVPRIVATE_C  0x89FC
#define TARGET_SIOCDEVPRIVATE_D  0x89FD
#define TARGET_SIOCDEVPRIVATE_E  0x89FE
#define TARGET_SIOCDEVPRIVATE_F  0x89FF

#define SIOCDEVPRIVATE_0 TARGET_SIOCDEVPRIVATE_0
#define SIOCDEVPRIVATE_1 TARGET_SIOCDEVPRIVATE_1
#define SIOCDEVPRIVATE_2 TARGET_SIOCDEVPRIVATE_2
#define SIOCDEVPRIVATE_3 TARGET_SIOCDEVPRIVATE_3
#define SIOCDEVPRIVATE_4 TARGET_SIOCDEVPRIVATE_4
#define SIOCDEVPRIVATE_5 TARGET_SIOCDEVPRIVATE_5
#define SIOCDEVPRIVATE_6 TARGET_SIOCDEVPRIVATE_6
#define SIOCDEVPRIVATE_7 TARGET_SIOCDEVPRIVATE_7
#define SIOCDEVPRIVATE_8 TARGET_SIOCDEVPRIVATE_8
#define SIOCDEVPRIVATE_9 TARGET_SIOCDEVPRIVATE_9
#define SIOCDEVPRIVATE_A TARGET_SIOCDEVPRIVATE_A
#define SIOCDEVPRIVATE_B TARGET_SIOCDEVPRIVATE_B
#define SIOCDEVPRIVATE_C TARGET_SIOCDEVPRIVATE_C
#define SIOCDEVPRIVATE_D TARGET_SIOCDEVPRIVATE_D
#define SIOCDEVPRIVATE_E TARGET_SIOCDEVPRIVATE_E
#define SIOCDEVPRIVATE_F TARGET_SIOCDEVPRIVATE_F
